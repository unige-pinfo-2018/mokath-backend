...
(1, '2018-05-29 05:36:59', 'ANSWER-1 1 1 dkasf ui. Thjdba sah ! 1 1 contactsdfklacom.', '0', 1, 1),
(2, '2018-05-29 05:36:59', 'ANSWER-2 1 1 dkasf ui. Thjdba sah ! 1 1 contactsdfklacom.', '0', 1, 1),
(3, '2018-05-29 05:36:59', 'ANSWER-3 1 1 dkasf ui. Thjdba sah ! 1 1 contactsdfklacom.', '0', 2, 1),
(4, '2018-05-29 05:36:59', 'ANSWER-4 1 1 dkasf ui. Thjdba sah ! 1 1 contactsdfklacom.', '0', 3, 1),
(5, '2018-05-29 05:37:00', 'ANSWER-5 2 2 dkasf ui. ThjdEWIWD, CEWOL UINFEOF CEWI ba sah ! 2 2 contactsdfklacom.', '0', 1, 2),
(6, '2018-05-29 05:37:00', 'ANSWER-6 2 2 dkasf ui. ThjdEWIWD, CEWOL UINFEOF CEWI ba sah ! 2 2 contactsdfklacom.', '0', 1, 2);
...
ALTER TABLE ANSWER ADD FOREIGN KEY (author_id) REFERENCES User(id);
ALTER TABLE ANSWER ADD FOREIGN KEY (question_id) REFERENCES Question(id);
--
-- Indexes for table `Institution_domains`
--
ALTER TABLE Institution_domains ADD FOREIGN KEY (`Institution_id`) REFERENCES public.Institution(id);

--
-- Indexes for table `Question`
--
ALTER TABLE QUESTION ADD FOREIGN KEY (author_id) REFERENCES public.User(id);;

--
-- Indexes for table `Question_domains`
--
ALTER TABLE Question_domains ADD FOREIGN KEY (Question_id) REFERENCES public.Question(id);

--
-- Indexes for table `User`
--
ALTER TABLE User ADD FOREIGN KEY (institution_id) REFERENCES public.Institution(id);

--
-- Indexes for table `user_follow_question`
--
ALTER TABLE user_follow_question ADD FOREIGN KEY (question_id) REFERENCES public.Question(id);

--
-- Indexes for table `user_upvote_answer`
--
ALTER TABLE user_upvote_answer ADD FOREIGN KEY (answer_id) REFERENCES public.answer(id);

--
-- Indexes for table `user_upvote_question`
--
ALTER TABLE user_upvote_question ADD FOREIGN KEY (question_id) REFERENCES public.question(id);
